...
O primeiro é o evento **KeyPress**, que é chamado quando uma tecla representando um caractere ASCII é pressionada.
Usando o evento **KeyPress**, não podemos determinar se **teclas modificadoras** foram pressionadas. Para determinar tais ações, manipule os eventos **KeyUp** e **KeyDown**.
